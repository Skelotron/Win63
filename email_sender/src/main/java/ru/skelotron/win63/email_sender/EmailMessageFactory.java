...
public final class EmailMessageFactory {
    ...
    public Message createMessage(Email email, Session session) throws MessagingException, IOException {
    ...
    private void addAttachments(Email email, Multipart multipart) throws MessagingException, IOException {
